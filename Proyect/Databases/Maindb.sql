CREATE DATABASE  IF NOT EXISTS `pridestore` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish_ci */;
USE `pridestore`;
-- MySQL dump 10.13  Distrib 8.0.12, for Win64 (x86_64)
--
-- Host: localhost    Database: pridestore
-- ------------------------------------------------------
...
CREATE TABLE `categories` (
  ...
  `NameCat` varchar(25) COLLATE utf8_spanish_ci NOT NULL,
  PRIMARY KEY (`idCat`),
...
CREATE TABLE `products` (
  ...
  `CategoryProd` int(10) unsigned NOT NULL,
  PRIMARY KEY (`IdProd`),
...
-- Dump completed on 2018-10-14 10:44:25
